...
const HomePage = ({ isDarkMode }) => {
    ...
    return (
        <div className={`relative min-h-screen overflow-hidden ${isDarkMode ? 'text-dark' : 'text-light'} transition-colors duration-500`}>
            <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
                <h1 className='text-center text-5xl sm:text-6xl font-bold text-ellipsis mb-4'>
                ...
                <div className='container w-full mx-auto'>
                    <img src="src/components/assets/E-comm.png" alt="Hero Pic" className="w-full h-56 object-cover" />
                </div>
